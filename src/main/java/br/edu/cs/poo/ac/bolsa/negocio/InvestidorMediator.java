...
public class InvestidorMediator {
    ...
    public MensagensValidacao incluirInvestidorPessoa(InvestidorPessoa investidor) {
        ...
        if (investidor == null) { msgs.adicionar("Investidor não pode ser nulo"); return msgs; }
        if (!daoInvPes.incluir(investidor)) msgs.adicionar("Investidor já cadastrado");
        return msgs;
    }
    ...
    public MensagensValidacao alterarInvestidorPessoa(InvestidorPessoa investidor) {
        MensagensValidacao msgs = new MensagensValidacao();
        if (investidor == null) { msgs.adicionar("Investidor não pode ser nulo"); return msgs; }
        if (!daoInvPes.alterar(investidor)) msgs.adicionar("Investidor não cadastrado");
        return msgs;
    }

    public MensagensValidacao excluirInvestidorPessoa(String cpf) {
        MensagensValidacao msgs = new MensagensValidacao();
        if (!daoInvPes.excluir(cpf)) msgs.adicionar("Investidor não cadastrado");
        return msgs;
    }
    ...
    public MensagensValidacao incluirInvestidorEmpresa(InvestidorEmpresa investidor) {
        MensagensValidacao msgs = new MensagensValidacao();
        if (investidor == null) { msgs.adicionar("Investidor não pode ser nulo"); return msgs; }
        if (!daoInvEmp.incluir(investidor)) msgs.adicionar("Investidor já cadastrado");
        return msgs;
    }
    ...
    public MensagensValidacao alterarInvestidorEmpresa(InvestidorEmpresa investidor) {
        MensagensValidacao msgs = new MensagensValidacao();
        if (investidor == null) { msgs.adicionar("Investidor não pode ser nulo"); return msgs; }
        if (!daoInvEmp.alterar(investidor)) msgs.adicionar("Investidor não cadastrado");
        return msgs;
    }

    public MensagensValidacao excluirInvestidorEmpresa(String cnpj) {
        MensagensValidacao msgs = new MensagensValidacao();
        if (!daoInvEmp.excluir(cnpj)) msgs.adicionar("Investidor não cadastrado");
        return msgs;
    }
